...
const EducationForm: React.FC<{
  ...
  return (
    <div className="w-full h-full  bg-white mx-auto rounded-lg absolute top-1 right-0 z-50 ">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-semibold p-4 rounded-lg text-sky-500">
          Add Education
        </h1>
        <div className="mr-4" onClick={() => setIsMenuOpen(false)}>
          <X />
        </div>
      </div>
      <form action="" className="p-8 flex flex-col gap-3 text-gray-500 ">
